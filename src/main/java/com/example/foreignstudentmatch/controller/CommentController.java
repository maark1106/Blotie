...
public class CommentController {
    ...
    public ResponseDto<?> saveComment(@PathVariable("feed_id") Long feedId, @RequestBody CommentSaveRequestDto commentSaveRequestDto) {
        return new ResponseDto<>(commentService.saveComment(feedId, commentSaveRequestDto));
    }
}
